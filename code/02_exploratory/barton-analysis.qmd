...
get_nearby_snps <- function(dat, lead_snp_annot, n_snps = 1000, info_threshold = 0.9, max_distance = 10000){
    nearby_snps <- dat %>%
        ...
        dplyr::filter(INFO > info_threshold, distance < max_distance) %>%
