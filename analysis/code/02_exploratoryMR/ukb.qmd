...
```{r}
# read full results file from neale lab 
file <- here::here("analysis", "data", "ukb", "N18.gwas.imputed_v3.female.tsv.bgz")
full <- file |> vroom::vroom()
# 194174 subjects for female only file
```
